class CaseUtil {
  ...
  CaseUtil(String text, {String? alternativeText, List<String> removeSuffixes = const []}) {
    for (final removeSuffix in removeSuffixes) {
      ...
      if (alternativeText != null && alternativeText.toLowerCase().endsWith(removeSuffix.toLowerCase())) {
        alternativeText = alternativeText.substring(0, alternativeText.length - removeSuffix.length);
      }
    }
    originalText = text;
